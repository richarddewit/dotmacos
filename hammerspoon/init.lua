-- Initial version taken from Awesome Hammerspoon:
...
if not hsapp_list then
    hsapp_list = {
        ...
        {modifier = 'shift', key = 's', name = 'Simulator'},
...
for _, v in ipairs(hsapp_list) do
    if v.id then
        ...
        if located_name then
            cmodal:bind(v.modifier or '', v.key, located_name, function()
                hs.application.launchOrFocusByBundleID(v.id)
                spoon.ModalMgr:deactivate({"appM"})
            end)
        end
    elseif v.name then
        cmodal:bind(v.modifier or '', v.key, v.name, function()
...
if spoon.WinWin then
    ...
    cmodal:bind('shift', 'H', 'Decrease Size Left', function() spoon.WinWin:stepResize("left") end, nil, function() spoon.WinWin:stepResize("left") end)
    cmodal:bind('shift', 'L', 'Increase Size Left', function() spoon.WinWin:stepResize("right") end, nil, function() spoon.WinWin:stepResize("right") end)
    cmodal:bind('shift', 'K', 'Decrease Size Down', function() spoon.WinWin:stepResize("up") end, nil, function() spoon.WinWin:stepResize("up") end)
    cmodal:bind('shift', 'J', 'Increase Size Down', function() spoon.WinWin:stepResize("down") end, nil, function() spoon.WinWin:stepResize("down") end)
